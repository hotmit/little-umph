...
namespace LittleUmph
{
    ...
    public class UI
    {
        ...
        #region [ Get/Set Radio Button Index ]
        /// <summary>
        ...
        /// <returns></returns>
        public static List<int> RichtextHighlight(RichTextBox richTextBox, string searchText, Color unselectedTextColor, Font highlightTextFont, Color highlightColor)
        {
            ...
            return RichtextHighlight(richTextBox, xpr, unselectedTextColor, highlightTextFont, highlightColor);
        }
        ...
        /// <param name="highlightColor">Color of the highlight.</param>
        /// <returns></returns>
        public static List<int> RichtextHighlight(RichTextBox richTextBox, Regex searchExpression, Color unselectedTextColor, Font highlightTextFont, Color highlightColor)
        {
            try
            {
