...
namespace LittleUmph
{
    ...
    public class Num
    {
        ...
        /// </summary>
        /// <param name="number">The number.</param>
        /// <param name="maxLimit">The max limit (not inclusive).</param>
        /// <returns>Return maxLimit-1 beyond the maxLimit</returns>
        public static int MaxFilter(int number, int maxLimit)
        {
            return MaxFilter(number, maxLimit, maxLimit - 1);
        }
        ...
        /// <returns></returns>
        public static int MaxFilter(int number, int maxLimit, int valueBeyondLimit)
        {
            if (number >= maxLimit)
            {
                return valueBeyondLimit;
