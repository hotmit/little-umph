...
namespace LittleUmph
{
    ...
    public class Diff
    {
        ...
        /// </returns>
        /// <example>"Hello world! 1" and "hello world, 2" => this would yield a match of 50% (2match/4total words)</example>
        ...
        /// <returns></returns>
        /// <see cref="http://www.dotnetperls.com/levenshtein">Code Source</see>
